...
(function (DeclarationTools) {
    ...
    (function (Type) {
        ...
        Type["array"] = "array";
        Type["any"] = "any";
    })(Type = DeclarationTools.Type || (DeclarationTools.Type = {}));
    let Place;
    (function (Place) {
    ...
    DeclarationTools.identifyType = (data) => {
        let result = Type.any;
    ...
    })(SchemaErrorType = DeclarationTools.SchemaErrorType || (DeclarationTools.SchemaErrorType = {}));
    const dataIterator = (data, schema, key, handle) => {
        const type = DeclarationTools.identifyType(data);
        ...
        if (type === Type.array) {
            ...
            for (let i = 0; i < data.length; i += 1) {
                ...
                if (DeclarationTools.identifyType(data[i]) === Type.object) {
                    if (keysMounted) {
    ...
    DeclarationTools.makeSchema = (data) => {
        const schema = { schema: {} };
    ...
    DeclarationTools.checkSchema = (schema, data) => {
        const errors = [];
        const undefinedKeys = [];
        dataIterator(data, schema, schemaKey, (schema, key, place) => {
...
})(DeclarationTools || (DeclarationTools = {}));
